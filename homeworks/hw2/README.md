...
1.  С помощью функции `as.vector()` превратите полученную матрицу E в вектор и выведите на экран индексы пропущенных значений.
...
Используя код с лекции и семинара 1, сгенерируйте следующие векторы:
